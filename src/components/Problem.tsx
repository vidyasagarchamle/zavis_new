...
export default function Problem() {
  ...
  return (
    <section id="problem" className="py-10 sm:py-12 md:py-16 bg-transparent relative" ref={containerRef}>
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-8 sm:mb-12 md:mb-16">
          ...
          <motion.p 
            className="text-[color:var(--foreground-secondary)] max-w-2xl mx-auto text-sm sm:text-base md:text-lg"
            initial={{ opacity: 0, y: 10 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
            {painPoints.map((point, index) => (
              <motion.div
                ...
                className="bg-background border border-border rounded-xl p-5 sm:p-6 hover:shadow-glow transition-all"
              >
                <div className="flex flex-col items-center text-center">
                  <div className="flex-shrink-0 p-2 sm:p-3 bg-accent/10 text-accent rounded-lg mb-3 sm:mb-4">
                    {point.icon}
                  </div>
                  <h3 className="text-lg sm:text-xl font-semibold mb-1 sm:mb-2">{point.title}</h3>
                  <p className="text-[color:var(--foreground-secondary)] text-xs sm:text-sm">{point.description}</p>
                </div>
              </motion.div>
            ))}
          </div>
          ...
          <div className="p-5 sm:p-6 md:p-8">
            <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-center">
              <div className="w-full md:w-1/2">
                <h3 className="text-xl sm:text-2xl font-bold mb-2 sm:mb-4">The Cost of Inaction</h3>
                <p className="text-[color:var(--foreground-secondary)] mb-3 sm:mb-4 text-xs sm:text-sm">Every missed call or long wait is a missed opportunity.</p>
                <ul className="space-y-2 sm:space-y-3">
                  {[
                    ...
                    >
                      <svg className="h-4 w-4 sm:h-5 sm:w-5 text-accent/70 mr-2 flex-shrink-0 mt-0.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="w-full md:w-1/2 bg-background-secondary rounded-xl p-4 sm:p-6">
                <div className="flex items-center justify-between mb-3 sm:mb-4">
                  <div>
                    <span className="text-[color:var(--foreground-secondary)] text-xs sm:text-sm">Annual Cost Impact</span>
                    <h4 className="text-2xl sm:text-3xl font-bold">$1.3 Trillion</h4>
                  </div>
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-accent/10 rounded-full flex items-center justify-center">
                    <svg className="w-4 h-4 sm:w-5 sm:h-5 text-accent" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="mt-4 sm:mt-6 pt-3 sm:pt-4 border-t border-border/30">
                  <p className="text-xs sm:text-sm font-medium">Stop paying for broken support. Let ZAVIS take over your calls — 24/7, with zero stress.</p>
                </div>
              </div>
            </div>
          </div>
